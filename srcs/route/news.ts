 ...
 */
router.get("/", [jwt.middleware, parserQuery(querySearch)], async(req, res) =>
{
	...
	var {anchor, duration, limit, medium, longitude, latitude, radius } = req.query;
	...
	var [artworks, events, artworksLike, eventFollow] = await Promise.all(promises);
